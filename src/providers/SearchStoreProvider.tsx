...
import { type SearchStore, createSearchStore, initSearchState } from '@/store/useSearchStore';

export type SearchStoreApi = ReturnType<typeof createSearchStore>;

export const SearchStoreContext = createContext<SearchStoreApi | undefined>(undefined);
...
export const SearchStoreProvider = ({ children }: SearchStoreProviderProps) => {
	...
	if (!storeRef.current) {
		storeRef.current = createSearchStore(initSearchState());
	}
